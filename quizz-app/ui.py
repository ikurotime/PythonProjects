...
class QuizInterface():
    ...
    def __init__(self,quiz_brain: QuizBrain):
        ...
        self.question_text = self.canvas.create_text(150, 125, text = "text",width = 280, font = FONT,fill= THEME_COLOR)
        ...
        self.score = Label(text = "Score: 0", padx = 20, pady = 20, bg = THEME_COLOR, fg = "white")
